...
def run_training():
    ...
    pipe = Pipeline([
        ...
        ('by_country_imputer', pp.CountryInterpolator(variables=cfg.NUMERICAL_VARS_WITH_NA)),
        ('group_imputer', pp.GroupedMedianImputer(variables=cfg.NUMERICAL_VARS_WITH_NA)),
        ('final_imputer', MeanMedianImputer(imputation_method='median', variables=cfg.NUMERICAL_VARS_WITH_NA)),
        ...
        ('reg', RandomForestRegressor(n_estimators=cfg.N_ESTIMATORS, random_state=cfg.SEED))
    ])
